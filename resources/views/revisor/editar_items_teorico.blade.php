...
@section('title', 'Editar Ítems Teóricos')
...
@section('content')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('revisor.guardar.itemsTeorico', $portafolio->id) }}" method="POST">
                @csrf
                ...
                <div class="mb-3 form-check">
                    <input type="checkbox" name="registro_entrega_silabo" id="registro_entrega_silabo" class="form-check-input" value="1" {{ old('registro_entrega_silabo', $itemsTeorico->registro_entrega_silabo ?? false) ? 'checked' : '' }}>
                ...
                <div class="mb-3 form-check">
                    <input type="checkbox" name="informe_examen_entrada" id="informe_examen_entrada" class="form-check-input" value="1" {{ old('informe_examen_entrada', $itemsTeorico->informe_examen_entrada ?? false) ? 'checked' : '' }}>
                ...
                <div class="mb-3 form-check">
                    <input type="checkbox" name="enunciado_y_solucion_exameN_1P" id="enunciado_y_solucion_exameN_1P" class="form-check-input" value="1" {{ old('enunciado_y_solucion_exameN_1P', $itemsTeorico->enunciado_y_solucion_exameN_1P ?? false) ? 'checked' : '' }}>
                ...
                <div class="mb-3 form-check">
                    <input type="checkbox" name="enunciado_y_solucion_exameN_2P" id="enunciado_y_solucion_exameN_2P" class="form-check-input" value="1" {{ old('enunciado_y_solucion_exameN_2P', $itemsTeorico->enunciado_y_solucion_exameN_2P ?? false) ? 'checked' : '' }}>
                ...
                <div class="mb-3 form-check">
                    <input type="checkbox" name="enunciado_y_solucion_exameN_3P" id="enunciado_y_solucion_exameN_3P" class="form-check-input" value="1" {{ old('enunciado_y_solucion_exameN_3P', $itemsTeorico->enunciado_y_solucion_exameN_3P ?? false) ? 'checked' : '' }}>
